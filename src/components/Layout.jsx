...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col min-h-screen min-h-dvh bg-[var(--color-bg-dark)]">
      ...
      {/* Bottom navigation */}
      <nav className="sticky bottom-0 bg-[var(--color-bg-card)] border-t border-white/10 safe-area-inset">
        <div className="flex justify-around py-2">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
                isActive ? 'text-[var(--color-primary)]' : 'text-white/60 hover:text-white'
              }`
            }
          >
